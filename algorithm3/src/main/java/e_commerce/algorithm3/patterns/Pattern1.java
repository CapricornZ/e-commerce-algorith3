package e_commerce.algorithm3.patterns;
...
public class Pattern1 {
	...
	static{
		...
		PATTERNS[0] = new Pattern1(new String[]{"AAAA","AABB","ABAB","ABBA",
				"BAAB","BABA","BBAA","BBBB"}, 2);
		PATTERNS[1] = new Pattern1(new String[]{"AAAB","AABA","ABAA","ABBB",
				"BAAA","BABB","BBAB","BBBA"}, 3);
	}
